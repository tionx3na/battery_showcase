# Generated by Django 3.1.3 on 2020-12-03 16:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_number', models.CharField(default=0, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vehicle_class', models.CharField(choices=[('TW', 'Three Wheeler'), ('SC', 'Small Car'), ('LC', 'Large Car'), ('XC', 'Extra Small Car'), ('TK', 'Truck'), ('BS', 'Bus'), ('TR', 'Tractor'), ('JB', 'JCB'), ('CV', 'Construction Vehicle'), ('BK', 'Bike'), ('SR', 'Scooter')], max_length=2)),
