...
urlpatterns = [
    ...
    path('details/<str:range>+range', views.details, name="details"),
    path('details/search/<str:range>+range<str:range_name>+range', views.search, name="search"),
    ...
    path('search2/adetails/<str:amodel>+range', views.amarondetails, name="adetails"),
]